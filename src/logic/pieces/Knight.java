...
//                    legalLogicMoves.add(new MajorLogicMove(logicBoard, this, candidateDestinationCoordinate));
...
//                        legalLogicMoves.add(new AttackLogicMove(logicBoard, this, candidateDestinationCoordinate,pieceAtDestination));
